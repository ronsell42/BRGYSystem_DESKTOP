...
Public Class rptClearance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BarangaySystem.rptClearance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClearance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClearance = New rptClearance()
        rpt.Site = Me.Site
        Return rpt
    End Function
