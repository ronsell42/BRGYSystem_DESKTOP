...
Public Class rptIndigency
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BarangaySystem.rptIndigency.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIndigency
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIndigency = New rptIndigency()
        rpt.Site = Me.Site
        Return rpt
    End Function
