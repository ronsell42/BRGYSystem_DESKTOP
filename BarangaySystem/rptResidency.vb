...
Public Class rptResidency
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BarangaySystem.rptResidency.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResidency
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResidency = New rptResidency()
        rpt.Site = Me.Site
        Return rpt
    End Function
